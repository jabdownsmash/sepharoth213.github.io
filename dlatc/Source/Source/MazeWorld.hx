...
class MazeWorld extends World {
    ...
    public function new(main:Main)
    {
        bpm = 112;
        maxColumns = 5;
        song = Assets.getSound('assets/lvl3-base.ogg');
        song2 = Assets.getSound('assets/lvl3-add.ogg');
        loopBeats = 128;
        ...
        obstacles.push(spawnObject(20,obstacleSprite,30+13,240));
        obstacles.push(spawnObject(20,obstacleSprite,32+13,180));
        obstacles.push(spawnObject(20,obstacleSprite,33+13,40));
        obstacles.push(spawnObject(20,obstacleSprite,33+13,80));
        obstacles.push(spawnObject(20,obstacleSprite,34+13,340));
        obstacles.push(spawnObject(20,obstacleSprite,35+13,240));
        obstacles.push(spawnObject(20,obstacleSprite,36+13,300));
        obstacles.push(spawnObject(20,obstacleSprite,38+13,110));
        obstacles.push(spawnObject(20,obstacleSprite,41+13,90));
        obstacles.push(spawnObject(20,obstacleSprite,42+13,120));
        obstacles.push(spawnObject(20,obstacleSprite,44+13,380));
        obstacles.push(spawnObject(20,obstacleSprite,44+13,200));
